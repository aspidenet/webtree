...
<div style="text-align:right;">
    <a class="ui blue button" onclick="modal_page_new('{$id}', '/modal/wizard/{$wizard_code}/relation/{$relation.relation_code}/new/master/{$step}', 'longer', func{$id}OnHide);">Nuovo</a>
    
    <a class="ui red button" onclick="wizard_update_relation_delete_selected();">Elimina</a>
</div>
{/if}

/modal/wizard/{$wizard_code}/relation/{$relation.relation_code}/new/master/{$step}
